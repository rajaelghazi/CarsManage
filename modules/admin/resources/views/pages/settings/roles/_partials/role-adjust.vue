<template>
	<BaseModal v-model="modifyRole" title="Nouveau rôle">
	  <template #action>
	  ...
	  <BaseCard>
		<FormField name="role_name" class="flex items-end gap-2 mb-5">
		  <div class="space-y-2 flex-1">
			...
			<InputText type="text" id="role_name" value="Gestionnaire des réservations" fluid />
		  </div>
		</FormField>
...
const modifyRole = ref(true);
const roleName = ref('Collaborateur');
